...
namespace Api.Rest.Migrations
{
    ...
    [Migration("20200207174338_Initial Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Rest.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Api.Rest.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Api.Rest.Entities.Course", b =>
                {
                    b.HasOne("Api.Rest.Entities.Author", "Author")
                        .WithMany("Courses")
